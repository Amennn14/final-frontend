...
function BuyPage() {
  const [buyOffers, setBuyOffers] = useState([
    {
      ...
      price: 2500000,
      location: "Malibu, CA",
      description: "A stunning mansion with ocean views and luxurious amenities.",
      images: [
  ...
  const handleSubmitOffer = (e) => {
    ...
    if (
      ...
      setBuyOffers([...buyOffers, { ...newOffer, id: buyOffers.length + 1 }]);
      setNewOffer({
        title: "",
        price: "",
        location: "",
